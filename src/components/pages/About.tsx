        ...
        <section id="about" className="page flex flex-col items-center justify-center px-6 md:px-12 lg:px-20 py-8 pt-20 md:pt-24">
            <div ref={elementRef} className={`max-w-[1200px] w-full transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                    <div className={`btb p-5 md:p-6 border border-[rgba(255,0,0,0.1)] hover:border-[rgba(255,0,0,0.3)] transition-all duration-500 hover:scale-[1.02] ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`} style={{ transitionDelay: '200ms' }}>
                    ...
                    <div className={`space-y-4 md:space-y-5 transition-all duration-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{ transitionDelay: '400ms' }}>
                        <div className="btb p-5 md:p-6 border border-[rgba(255,0,0,0.1)] hover:border-[rgba(255,0,0,0.3)] transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,0,0,0.2)] hover:scale-[1.02]">
